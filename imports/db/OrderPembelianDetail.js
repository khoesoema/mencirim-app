...
export const OrderPembelianDetailCollections = new Mongo.Collection('orderPembelianDetail');

export const orderPembelianDetailSchema = new SimpleSchema({
...
OrderPembelianDetailCollections.schema = orderPembelianDetailSchema;