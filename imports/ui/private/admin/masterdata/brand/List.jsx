...
// import { BrandsCollections } from '../../../../db/Brand';
...
export function BrandLists(props) {
	...
	const [brands, brandsLoading] = useTracker(() => {
		let subs = Meteor.subscribe('brands.list', {
			page,
			searchText,
	...
	const [brandsCount, brandsCountLoading] = useTracker(() => {
		let subs = Meteor.subscribe('brands.countList', { searchText });

		let data = Counts.get('brands.countList.' + searchText);
		return [data, !subs.ready()];
	}, [searchText]);

	useEffect(() => {
		setMaxPage(Math.ceil(brandsCount / 20));
	}, [brandsCount]);
				...
				<div className="mainContent">
					<div className="breadcrumContainer">
						...
						>
							...
							<Breadcrumb.Item active>Data Brand</Breadcrumb.Item>
						</Breadcrumb>
					</div>
					<h6>
						<b>Data Brand</b>
