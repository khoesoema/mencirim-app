...
export function ViewPurchaseRetur() {
	...
	const [pembelianData, pembelianDataLoading] = useTracker(() => {
		...
		if (_id) {
			let subs = Meteor.subscribe('returpembelian.getByID', { _id });
			isLoading = !subs.ready();

			data = ReturPembelianCollections.findOne({ _id });
		}
				...
				<div className="mainContent">
					<div className="breadcrumContainer">
						...
						>
							...
							>
								Data Transaksi Retur Pembelian
							</Breadcrumb.Item>
							<Breadcrumb.Item active>
								Lihat Data Transaksi Retur Pembelian -{' '} {noFaktur}
							</Breadcrumb.Item>
						</Breadcrumb>
					</div>
					<h6>
