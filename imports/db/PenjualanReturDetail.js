...
export const PenjualanReturDetailCollections = new Mongo.Collection('penjualanReturDetail');

export const penjualanReturDetailSchema = new SimpleSchema({
...
PenjualanReturDetailCollections.schema = penjualanReturDetailSchema;