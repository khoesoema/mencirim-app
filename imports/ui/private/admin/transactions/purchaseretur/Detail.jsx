...
export function EditPurchaseRetur() {
	let { _id } = useParams();
	...
	const [pembelianDetailCount, pembelianDetailCountLoading] = useTracker(() => {
		let subs = Meteor.subscribe('pembeliandetail.countList', { noFaktur });

		let data = Counts.get('pembeliandetail.countList.' + noFaktur);
	...
	useEffect(()=>{
		if (pembelianData && pembelianDataLoading === false ){
			...
			setKeterangan(pembelianData.keterangan);
			...
			<div className="mainContainerRoot">
				...
				<div className="mainContent">
					<div className="breadcrumContainer">
						...
						>
							...
							<Breadcrumb.Item active>
								Ubah Transaksi Retur Pembelian
							</Breadcrumb.Item>
						</Breadcrumb>
					</div>
					<h6>
						<b>Ubah Transaksi Retur Pembelian {noFaktur}</b>
					</h6>
					<hr />
					<Form
						onSubmit={() => {
					...
					>
						...
						<Form.Group controlId="noOrder" style={{ marginBottom: 10}}>
							<Form.ControlLabel className="text-left"> 
								Nomor Order
							</Form.ControlLabel>
							<Form.Control
