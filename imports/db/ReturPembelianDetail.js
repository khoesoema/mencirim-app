...
export const ReturPembelianDetailCollections = new Mongo.Collection('returPembelianDetail');

export const returPembelianDetailSchema = new SimpleSchema({
...
ReturPembelianDetailCollections.schema = returPembelianDetailSchema;