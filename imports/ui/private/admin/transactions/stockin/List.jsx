...
export function StockInLists(props) {
	...
	const [invoices, invoicesLoading] = useTracker(() => {
		let subs = Meteor.subscribe('stockIn.list', {
			page,
			searchText,
		...
		let data = StocksTransactionsCollections.find(
			{
				type: 1,
				invoiceNumber: {
					$regex: searchText,
	...
	const [invoicesCount, invoicesCountLoading] = useTracker(() => {
		let subs = Meteor.subscribe('stockIn.countList', {
			searchText,
		});

		let data = Counts.get('stockIn.countList.' + searchText);
		return [data, !subs.ready()];
	}, [searchText]);
				...
				<div className="mainContent">
					...
					<div className="breadcrumContainer">
						...
						>
							...
							<Breadcrumb.Item active>Stok Masuk</Breadcrumb.Item>
						</Breadcrumb>
					</div>
					<h6>
						<b>Stok Masuk</b>
