...
export const PembelianDetailCollections = new Mongo.Collection('pembelianDetail');

export const pembelianDetailSchema = new SimpleSchema({
...
PembelianDetailCollections.schema = pembelianDetailSchema;